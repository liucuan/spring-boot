package com.tone.shiro.security;
...
import com.tone.shiro.entity.JWTToken;
...
public class JWTFilter extends BasicHttpAuthenticationFilter {
     ...
     * 所以我们在这里返回true，Controller中可以通过 subject.isAuthenticated() 来判断用户是否登入 如果有些资源只有登入用户才能访问，我们只需要在方法上面加上 @RequiresAuthentication
